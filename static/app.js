...
(function initTheme() {
  ...
  if (btn) btn.textContent = current === "dark" ? "☀️ Mode clair" : "🌙 Mode sombre";
  if (img) img.src = current === "dark" ? "/static/logo_white.png" : "/static/logo.png";
  ...
  btn?.addEventListener("click", () => {
    ...
    if (img) img.src = next === "dark" ? "/static/logo_white.png" : "/static/logo.png";
  });
})();
